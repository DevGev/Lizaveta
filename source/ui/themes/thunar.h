/* theme.h - Thunar-style color palette. */
...
static const xc_color liz_theme_bg         = LIZ_COL_RGB(0x21, 0x21, 0x28);
static const xc_color liz_theme_panel      = LIZ_COL_RGB(0x2b, 0x2b, 0x33);
